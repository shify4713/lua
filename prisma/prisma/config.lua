...
C.defaults = {
  ...
  reactors = {
    ...
    tempCrit = 8100,        -- критическая: режем до initialFlow
    initialFlow = 535000,
    boostFlow = 1200000,    -- потолок разгона (RF/t)
    boostStep = 4000,       -- обычный шаг разгона
    manualStep = 10000,
    detectOutMin = 530000,
    detectInMax = 500000,
    ...
    coldBoostStep = 12000,  -- увеличенный шаг разгона на холодном топливе, RF/t
