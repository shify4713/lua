...
local function makeTasks(P)
  ...
  local list = {
    ...
    { name = "ME-очередь", every = 0.05, on = always,                                        fn = function() P.me.pump(2) end },
    ...
    { name = "память",     every = 30,   on = always,                                        fn = function() if collectgarbage then pcall(collectgarbage) end end },
  }
