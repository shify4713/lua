...
C.defaults = {
  ...
  ui = {
    ...
    clockOffset = 0,      -- часовой сдвиг часов (если время сервера/OC не совпадает с реальным)
    tab = "dash",
  },
  ...
  reactors = {
    ...
    forceModeTemp = 7500,
    targetTemp = 7800,      -- целевая температура удержания (плавный выход и стоп на ней)
    safeModeTemp = 8000,
    tempCrit = 8100,
    initialFlow = 535000,
    manualStep = 10000,
